<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"E:\www\zbzx\public/../application/index\view\site_1\cms\category_default_detail.html";i:1505032764;s:51:"../application/index/view/site_1/public/header.html";i:1505215572;s:51:"../application/index/view/site_1/public/footer.html";i:1505057297;}*/ ?>
<?php
		...
		<div class="mainBox" id="detailsBox">
			<div class="wBd">
				<div class="articleCon">
					<h2 class="title" style="color:"><?php echo $article['title']; ?></h2>
					<h4 class="subTitle"></h4>
					<div class="property"> 
						<span>文章来源：<?php echo $article['source']; ?></span>
						<span>发布时间：<?=date('Y年m月d日', $article['updatetime']);?></span> 
						<span>点击数：<?php echo $article['hits']; ?>次</span>
					</div>
					<div class="conTxt">
					  <p><?php echo $article['content']; ?></p>
					</div>
					<div class="pageShow"> <span id="pe100_page_contentpage" class="pagecss"></span> </div>
					<div class="property2">
					  <a class="dyBtn"  href="#this" onclick="javascript:alert('demo版暂不支持此功能');">【打印文章】</a>
					  <a class="scBtn"  href="#this" onclick="javascript:alert('demo版暂不支持此功能');">【添加收藏】</a>
					</div>
					<div class="others">
					  <div class="prev">
					  	<font>上一篇：</font>
					  	<a href="#this" onclick="javascript:alert('demo版暂不支持此功能');">关于商请协助做好《教育与装备研究》期刊2018年征订工作的函</a>[ 04-29 ]</div>
					    <div class="next"><font>下一篇：没有了！</font></div>
					</div>
				</div>
			</div>
		</div>
